            ...
            <div class="row">
                ...
                <div class="col">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" value="<?= old('merek'); ?>" id="merek" name="merek" autofocus>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" value="<?= old('tahun'); ?>" id="tahun" name="tahun">
                        <small id="emailHelp" class="form-text text-muted">Tahun Pembuatan.</small>
                    </div>
                    <div class="mb-3">
                        <label for="transmisi" class="form-label">transmisi</label>
                        <input type="text" class="form-control" value="<?= old('transmisi'); ?>" id="transmisi" name="transmisi">
                        <small id="emailHelp" class="form-text text-muted">Manual / Automatic.</small>
                    </div>
                    <div class="mb-3">
                        <label for="berlaku" class="form-label">berlaku</label>
                        <input type="text" class="form-control" value="<?= old('berlaku'); ?>" id="berlaku" name="berlaku">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" value="<?= old('kepemilikan'); ?>" id="kepemilikan" name="kepemilikan">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" value="<?= old('kilometer'); ?>" id="kilometer" name="kilometer">
                        <small id="emailHelp" class="form-text text-muted">Jumlah kilometer yang sudah ditempuh.</small>
                    </div>
                    <div class="mb-3">
                        <label for="harga" class="form-label">Harga</label>
                        <input type="text" class="form-control" value="<?= old('harga'); ?>" id="harga" name="harga">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" value="<?= old('baha-bakar'); ?>" id="bahan-bakar" name="bahan-bakar">
                ...
                <div class="col">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" value="<?= old('kapasitas_mesin'); ?>" id="kapasitas_mesin" name="kapasitas_mesin">
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control" value="<?= old('gambar'); ?>" type="file" id="gambar" name="gambar">
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control" value="<?= old('slide-1'); ?>" type="file" id="slide-1" name="slide-1">
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control" value="<?= old('slide-2'); ?>" type="file" id="slide-2" name="slide-2">
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control" value="<?= old('slide-3'); ?>" type="file" id="slide-3" name="slide-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control" value="<?= old('slide-4'); ?>" type="file" id="slide-4" name="slide-4">
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control" value="<?= old('slide-5'); ?>" type="file" id="slide-5" name="slide-5">
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control" value="<?= old('slide-6'); ?>" type="file" id="slide-6" name="slide-6">
