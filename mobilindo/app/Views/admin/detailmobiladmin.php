...
<div class="container">
    <div class="row">
        <div class="col">
            <p><a href="<?= base_url('/'); ?>" class=" link-primary">Home&nbsp;&nbsp; </a><a href="<?= base_url('admin/daftarmobiladmin'); ?>"> > &nbsp;&nbsp;Daftar Mobil Admin&nbsp;&nbsp;</a><a class="text-capitalize" href="<?= base_url('admin/detailmobiladmin'); ?>"> >&nbsp;&nbsp; <?= $mobil['slug']; ?></a> </p>
        </div>
    </div>
</div>
<br>
...
<div class="container">
    ...
    <!-- delet -->
    <a class="btn btn-outline-success" href="<?php echo base_url('daftarmobil/edit/' . $mobil['id']); ?>" role="button"><i class="fas fa-edit"></i>Edit</a>
    <a href="<?php echo base_url('daftarmobil/delete/' . $mobil['id']); ?>" class="btn btn-danger btn-sm" onclick="return confirm('Apakah Anda yakin ingin menghapus produk <?php echo $mobil['nama']; ?> ini?')"><i class="fas fa-trash-alt"></i>Hapus</a>
