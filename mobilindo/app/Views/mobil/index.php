...
<div class="container">
    <div class="row">
        <div class="col">
            <p><a href="<?= base_url('/'); ?>" class=" link-primary">Home &nbsp;&nbsp; </a><a href="<?= base_url('/Daftarmobil'); ?>"> > &nbsp;&nbsp;Daftar Mobil</a> </p>
        </div>
    </div>
</div>
<br>
        ...
        <?php foreach ($order as $m) : ?>
            <div class="col">
                <div class="card h-100">
                    <a href="/mobil/<?= $m['slug']; ?>"><img src="/img/daftarmobil/<?= $m['gambar']; ?>" class="card-img-top" alt="..."></a>
                    <div class="card-body">
                        ...
                        <a href="/mobil/<?= $m['slug']; ?>" class="card-link">Selengkapya ></a>
                    </div>
                </div>
            </div>
        <?php endforeach; ?>
